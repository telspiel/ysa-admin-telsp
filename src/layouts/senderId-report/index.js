...
$(() => {
  ...
  $("#controls-form").submit(function (e) {
    ...
    Request(Endpoints.get("senderIdSummaryReport"), "POST", data, {
      showMainLoader: true
    }).done(data1 => {
...
Request(Endpoints.get("senderIdSummaryReport"), "POST", data).done(data1 => {
  renderDetailedMis(data1);
  console.log(data1);
  var donwloadlink = data1.data.downloadReportLink;
  ...
  $('#donwloadFileButton').on('click', 'a', function (e) {
    ...
    xhttp.onreadystatechange = function () {
      ...
      if (xhttp.readyState === 4 && xhttp.status === 200) {
        ...
        a.download =  User.getName()+"-"+dTime+"-senderIpReport.csv";
