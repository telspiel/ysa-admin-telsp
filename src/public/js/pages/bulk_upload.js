...
$("#addMoreRows").click(function() {
    $('.add_split_row').append(`<div class="form-group row split_row"><label for="scheduleMessage" class="col-md-4 col-form-label"></label><div class="col-md-6 split_row_child"><div class="row">
                <div class="col-3 pr-0"><input type="number" max="31" min="1" name="split_date" id="split_date" class="form-control" placeholder="From"></div>
                <div class="col-3 pr-0"><input type="number" max="31" min="1" name="split_date" id="split_date" class="form-control" placeholder="To"></div>
